  ...
  return (
    <>
        <Container className='mt-4'>
            ...
            <hr />
                <div className='container d-flex justify-content-center w-75' style={{gap: '2em', flexWrap: 'wrap'}}>
                    <div className='col'>
                        <div id='profile' style={{margin: '0 auto'}}></div>
                    </div>
                    <div className='col'>
                        <span style={{fontSize: '2.3em'}}>Citlalli Moctezuma</span>
                        <p>
                        Health Coach Certificada por el IIN (Institute for Integrative Nutrition de Nueva York). 
